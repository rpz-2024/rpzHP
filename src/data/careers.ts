  ...
  occupations: [
    {
      ...
      steps: [
        { title: "新人社員", body: "基本オペレーションと衛生基準を習得。現場に慣れます。" },
        { title: "一般社員", body: "仕込み・調理を主体的に担当。後輩サポートにも関与。" },
        { title: "料理長", body: "厨房全体の衛生・コスト管理とメニュー企画を担います。" },
        { title: "エリア料理長 / マネージャー", body: "複数店舗のクオリティ統括、人材育成、標準化を推進。" },
      ],
    },
    {
      id: "hall",
      ...
      steps: [
        { title: "新人社員", body: "基本接客とホスピタリティ基準を習得。現場に慣れます。" },
        { title: "一般社員", body: "店舗運営・マニュアル管理・スタッフ育成。" },
        { title: "副店長 / 店長", body: "売上・人員・在庫・CS を統合的にマネジメント。" },
        { title: "スーパーバイザー / マネージャー", body: "複数店舗の数値管理・教育設計・施策展開を担います。" },
      ],
    },
    {
      id: "hq",
      ...
      steps: [
        { title: "アシスタント", body: "基礎業務を習得し、課題把握とドキュメント化を担当。" },
        { title: "担当 / リーダー", body: "小〜中規模プロジェクトを主担当として推進。" },
        { title: "マネージャー", body: "KPI 設計・効果検証・人材育成で全社最適化を図る。" },
      ],
    },
  ],
